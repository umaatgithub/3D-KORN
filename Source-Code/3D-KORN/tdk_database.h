...
public:
    ...
    ~TDK_Database();
    static void mf_StaticAddPointCloud(pcl::PointCloud<pcl::PointXYZRGB>::Ptr pointCloudPtr, unsigned int rotationAngle = 0,  QString pointCloudName = "U1425_AUTOGENERATE");
    static void mf_StaticAddRegisteredPointCloud(pcl::PointCloud<pcl::PointXYZRGB>::Ptr registeredPointCloudPtr, QString registeredPointCloudName = "U1425_AUTOGENERATE");
    static void mf_StaticAddMesh(pcl::PolygonMesh::Ptr meshPtr, QString meshName = "U1425_AUTOGENERATE");
