...
public:
    ...
    pcl::PointCloud<pcl::PointXYZRGB>::Ptr mf_GetMvPointCloud() const;
    void mf_SetMvPointCloud(const pcl::PointCloud<pcl::PointXYZRGB>::Ptr &pointCloudPtr);
...
protected:
    ...
    pcl::PointCloud<pcl::PointXYZRGB>::Ptr mv_PointCloud;
