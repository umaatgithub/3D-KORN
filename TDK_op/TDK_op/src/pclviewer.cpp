...
//  pcl::PointCloud<pcl::PointXYZ>::Ptr cloud(new pcl::PointCloud<pcl::PointXYZ>());
 ...
 // pcl::PointCloud<pcl::PointXYZ>::Ptr clouda(new pcl::PointCloud<pcl::PointXYZ>());
  ...
  //pcl::io::loadPCDFile<pcl::PointXYZ> ("alb1.pcd" , *cloud);
    pcl::io::loadPCDFile<pcl::PointXYZ> ("bun0-mls.pcd" , *cloud);
   //pcl::io::loadPCDFile<pcl::PointXYZ> ("alb-mls.pcd" , *cloud);

 // pcl::io::loadPLYFile<pcl::PointXYZ> ("pamir.ply" , *cloud);
