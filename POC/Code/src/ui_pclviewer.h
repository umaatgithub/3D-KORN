...
**
** Created: Fri Sep 30 21:58:06 2016
...
public:
    ...
    void setupUi(QMainWindow *PCLViewer)
    {
        ...
        pushButton_load->setGeometry(QRect(40, 370, 201, 20));
    ...
    void retranslateUi(QMainWindow *PCLViewer)
    {
        ...
        pushButton_random->setText(QApplication::translate("PCLViewer", "basic denoising & Poisson & save", 0, QApplication::UnicodeUTF8));

        pushButton_load->setText(QApplication::translate("PCLViewer", "loading the saved file and mesh display ", 0, QApplication::UnicodeUTF8));
    } // retranslateUi
